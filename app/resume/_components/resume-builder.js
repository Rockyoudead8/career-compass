...
import { resumeSchema, coverLetterSchema } from "../../lib/schema"
...
const resumeBuilder = ({ initialContent }) => {
    ...
    useEffect(() => {
        if (activeTab === "edit") {
            const newContent = getCombinedData();
    ...
    return (
        <div>
            <div className='flex justify-between items-center mt-10'>
                <h1 className='text-6xl font-bold gradient-background'>Resume Builder</h1>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-10">
                ...
                <TabsContent value="edit"><form className="space-y-8">
                    {/* Contact Information */}
                ...
                <TabsContent value="preview">
                    ...
                    <div className="absolute top-[-9999px] left-[-9999px] w-[794px] p-6 bg-white text-black text-base leading-relaxed">
                        <div id="resume-pdf">
                            <MDEditor.Markdown
